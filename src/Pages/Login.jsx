...
const Login = () => {
    ...
    const handleLoginWithZoho = () => {
        ...
        window.location.href = `${import.meta.env.VITE_API_URL}/auth/zoho?redirect=${frontendRedirectUrl}`
    }
        ...
        <section className=' fixed w-full h-full left-0 z-50 flex justify-center items-center bg-white'>
            <div className='login flex mx-12 py-12 sm:py-0 lg:mx-[17rem]'>
                <div className=' login-page w-full sm:px-3  sm:w-[50%] flex flex-col justify-center items-center'>
                    ...
                    <button onClick={handleLoginWithZoho} className='  text-[16px] flex items-center gap-3 py-1 hover:bg-[#DD5709] hover:text-white px-2 mt-5 text-[#DD5709] border-[1px] border-solid border-[#DD5709] rounded-md'><SiZoho className=' text-4xl' />Login with Zoho</button>
                </div>
